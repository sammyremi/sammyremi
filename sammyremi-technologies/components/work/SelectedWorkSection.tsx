                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col gap-6 max-w-4xl">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className="w-10 h-10 rounded-full border border-neutral-300 dark:border-neutral-700 text-neutral-800 dark:text-white flex items-center justify-center group-hover:bg-[#D96B18] group-hover:text-white group-hover:border-[#D96B18] transition-all duration-300 group-hover:scale-110"
                      >
