    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-12 sm:gap-16 z-10 relative">
        ...
        <ScrollReveal direction="up" delay={0.3}>
          <div className="flex flex-wrap gap-x-8 gap-y-4 text-neutral-300 font-medium text-lg sm:text-2xl">
        ...
        {/* Highlight Solution Banner */}
        <ScrollReveal direction="up" delay={0.4}>
          <a
            href="#contact"
            className="group block bg-[#D96B18] hover:bg-[#B8550B] text-white p-8 sm:p-12 rounded-3xl transition-all duration-300 shadow-2xl shadow-[#D96B18]/25 hover:shadow-[#D96B18]/40 active:scale-[0.99]"
          >
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              ...
              <span className="w-14 h-14 rounded-full border-2 border-white/40 flex items-center justify-center group-hover:border-white group-hover:bg-white group-hover:text-[#D96B18] transition-all duration-300 shrink-0">
