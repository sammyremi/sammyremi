    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-12 sm:gap-16 z-10 relative">
        ...
        <StickyCardStack>
          ...
          <div className="bg-[#F8FAFC] dark:bg-[#131622] text-neutral-900 dark:text-white p-8 sm:p-12 md:p-14 rounded-3xl border border-neutral-200/80 dark:border-white/10 shadow-xl flex flex-col gap-8 relative overflow-hidden">
            ...
            <div className="flex flex-wrap gap-x-8 gap-y-4 text-neutral-700 dark:text-neutral-300 font-medium text-lg sm:text-2xl pt-2">
          ...
          {/* Card 02: Vibrant Brand Orange Solution Banner Card */}
          <a
            href="#contact"
